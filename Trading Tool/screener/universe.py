...
SP500 = [
    ...
    "CAH","KMX","CCL","CARR","CAT","CBOE","CBRE","CDW","CE","COR","CNC","CNP","CF",
    ...
    "DECK","DE","DAL","XRAY","DVN","DXCM","FANG","DLR","DG","DLTR","D","DPZ","DOV",
    ...
    "IBM","IEX","IDXX","ITW","ILMN","INCY","IR","PODD","INTC","ICE","IFF","IP","INTU",
    ...
    "ORCL","OTIS","PCAR","PKG","PLTR","PANW","PH","PAYX","PAYC","PYPL","PNR","PEP",
    ...
    "VRSN","VRSK","VZ","VRTX","VTRS","V","VST","VMC","WRB","GWW","WAB","WMT","DIS",
    "WBD","WM","WAT","WEC","WFC","WELL","WST","WDC","WY","WMB","WTW","WSM","WYNN","XEL",
    "XYL","YUM","ZBRA","ZBH","ZTS",
]

NASDAQ100 = [
    "ABNB","ADBE","ADI","ADP","ADSK","AEP","AMAT","AMD","AMGN","AMZN","APP","ARM",
